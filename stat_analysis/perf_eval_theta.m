...
% only for model variants with theta module iModel = (1, 3, 5) <=> A, C, E
% model variants
N_model = 7; 
...
% only columns corresponding to the models with theta module would be populated.
fname = 'perf_internal_theta';
