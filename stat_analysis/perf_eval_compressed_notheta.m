...
for iModel = 2 :  2 : N_model
    fpath = fullfile(dataFold, ['reduced_compressed_' num2str(iModel)]);
...
perf_internal_notheta = perf_internal;
fname = 'perf_internal_compressed_notheta';
save(fname, 'perf_internal_notheta');
